...
ApplicationWindow {
    ...
    Component {
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                TextField { id: ein; placeholderText: "EPG (.gz)"; Layout.fillWidth: true; color: "white" }
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    height: 60
                    color: "#111111"
                    Label { anchors.centerIn: parent; text: "КАНАЛЫ ЭФИРА"; font.bold: true }
                }
                ListView {
                    id: clist
                    Layout.fillWidth: true
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        height: 60
                        color: "#111"
                        Label { anchors.centerIn: parent; text: "ПРОГРАММА / АРХИВ"; color: "#00E676" }
                    }
                    ListView {
                        id: elist
                        Layout.fillWidth: true
    ...
    Drawer {
        ...
        ColumnLayout {
            anchors.fill: parent
            anchors.margins: 15
            Label { text: "ПРОГРАММА ПЕРЕДАЧ"; font.bold: true; Layout.alignment: Qt.AlignHCenter }
            ListView {
                id: mepglist
                Layout.fillWidth: true
                Layout.fillHeight: true
