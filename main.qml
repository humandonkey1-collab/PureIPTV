...
// НЕ НАДО ЕГО ХВАЛИТЬ, У МЕНЯ ПОЛНОЕ ГОВНО, ГОВНО, ГОВНООООО!!!!!! ЭТОТ КОД — ХРЕНЬ, Я САМЫЙ ТУПОЙ ЧЕЛОВЕК НА СВЕТЕ, РАЗ ДОДУМАЛСЯ ТАКУЮ ХРЕНЬ НАХРЕНИТЬ!
// ААААААА!!!!! НИФИГА, Я НЕ УМНЫЙ!!!! ХВАТИТ МЕНЯ ХВАЛИТ, я люблю когда меня унижают 🤤 
// =========================================================================
