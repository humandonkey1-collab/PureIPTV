...
ApplicationWindow {
    ...
    Component {
        id: loginPage
        ColumnLayout {
            anchors.centerIn: parent; width: Math.min(parent.width*0.9, 450); spacing: 20
            Label { text: "PURE IPTV PREMIUM"; font.pixelSize: 36; font.bold: true; color: "#00E676"; Layout.alignment: Qt.AlignHCenter }
            TabBar { id: tabs; Layout.fillWidth: true; TabButton { text: "M3U" }; TabButton { text: "XTREAM" }; TabButton { text: "STALKER" } }
            TextField { id: hIn; placeholderText: "Server URL"; Layout.fillWidth: true; color: "white" }
            TextField { id: eIn; placeholderText: "EPG (.xml.gz)"; Layout.fillWidth: true; color: "white" }
            RowLayout {
                visible: tabs.currentIndex > 0; Layout.fillWidth: true
                TextField { id: uIn; placeholderText: "User"; Layout.fillWidth: true }
                TextField { id: pIn; placeholderText: "Pass/MAC"; Layout.fillWidth: true; echoMode: TextInput.Password }
            }
            Button { text: "CONNECT"; Layout.fillWidth: true; height: 60; highlighted: true
                     onClicked: backend.connect(tabs.currentIndex==0?"M3U":tabs.currentIndex==1?"XTREAM":"STALKER", hIn.text, eIn.text, uIn.text||"", pIn.text||"", pIn.text||"") }
    ...
    Component {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Rectangle { Layout.fillWidth: true; height: 60; color: "#111"; Label { anchors.centerIn: parent; text: "CHANNELS"; font.bold: true } }
                ListView {
                    ...
                    delegate: ItemDelegate {
                        ...
                        RowLayout {
                            ...
                            Rectangle { width: 60; height: 60; color: "#000"; radius: 8
                        ...
                        onClicked: { selCh = modelData; backend.updateEPG(modelData.id); if(!isWide) eDrawer.open() }
                    }
                }
            }
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Rectangle { Layout.fillWidth: true; height: 60; color: "#111"; Label { anchors.centerIn: parent; text: "EPG / ARCHIVE"; color: "#00E676" } }
                    ListView { id: elist; Layout.fillWidth: true; Layout.fillHeight: true; model: backend.epgModel; clip: true
                        delegate: ItemDelegate {
                            ...
                            onClicked: { backend.play(selCh.url, int(window.winId), model.startRaw); stack.push(playerPage) }
                        }
                    }
                }
            }
    ...
    Drawer { id: eDrawer; width: parent.width; height: parent.height*0.8; edge: Qt.BottomEdge; background: Rectangle { color: "#080808"; radius: 25 }
        ColumnLayout { anchors.fill: parent; anchors.margins: 15
            ...
            ListView { Layout.fillWidth: true; Layout.fillHeight: true; model: backend.epgModel; clip: true
                delegate: ItemDelegate { width: parent.width; height: 80
                    ColumnLayout { anchors.fill: parent; Label { text: model.displayTime; color: "#00E676" }; Label { text: model.title; color: "white" } }
                    onClicked: { backend.play(selCh.url, int(window.winId), model.startRaw); eDrawer.close(); if(stack.depth < 3) stack.push(playerPage) } } } }
    }
}
