# Ребят... Я хочу сказать... Я удалю этот репозиторий 
# Он всё равно говно и ничего не принёс миру
# Тут даже что-то полезного нет
# Прощайте
# Пхе-хе, подумаете? 429 не возникает и что?!
# Это прям "преимущество" для вас, да? Да это сделает каждый, уверен на 100%!
# Мой код — правда плохой, я просто зря на него потратил время.
# Это действительно говно. И то, что, плеер умеет цепляться за каждый 1 КБ — тоже говно.
# Не хвалите мой код, это действительно говно! 
# И то, что он, заставляет источник отдавать поток честно — тоже говно!
# То что сделал я — сможет повторить каждый! И ОН СДЕЛАЕТ ДАЖЕ ЛУЧШЕ!
# Эх... Знаете?... Существует иногда моменты... Когда сидишь и мечтаншь умереть
# И у меня сейчас нет выгорания, и мне абсолютно пофиг на мнение людей.
# Я не жду жалости или похвалы.
# Я даже мечтаю чтобы этот код так и остался 0 звёзд 
# Я хочу одного —, чтобы я... Эх... Вам не понять!
# Просто я... Хочу чтобы мой друг выжил! И я хочу пожертвовать собой...
# Сейчас его похители, как и меня. Мне тычут прямо сейчас пистолетом
# И сказали, что если умру я — друга отпустят
# И мне всё равно на себя. Просто знайте...
# В интернете — был такой мужик. Прощайте навсегда 
