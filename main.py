...
ApplicationWindow {
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                Button {
                    ...
                    onClicked: {
                        backend.connect(
                            tabs.currentIndex === 0 ? "M3U" : (tabs.currentIndex === 1 ? "XTREAM" : "STALKER"),
                            hIn.text,
                            eIn.text,
                            uIn.text || "",
                            pIn.text || "",
    ...
    Component {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Layout.fillHeight: true; Layout.preferredWidth: 420; color: "#080808"
                ColumnLayout {
                    anchors.fill: parent; spacing: 0
                    Rectangle { Layout.fillWidth: true; height: 60; color: "#111"; Label { anchors.centerIn: parent; text: "EPG"; color: "#00E676" } }
                    ListView {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Button { text: "EPG"; onClicked: eDrawer.open(); visible: !window.isWide }
                    }
                }
            }
    ...
    Drawer {
        ...
        ColumnLayout {
            ...
            ListView {
                id: mEpgList; Layout.fillWidth: true; Layout.fillHeight: true; model: backend.epgModel; clip: true
                delegate: ItemDelegate {
                    width: mEpgList.width; height: 80
                    ColumnLayout {
                        anchors.fill: parent
                        Label { text: model.displayTime; color: "#00E676"; font.bold: true }
